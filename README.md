...
<p align="center">
    <img src="/images/IMG_3758.jpg" height="600" alt="Photo of assembled keyboard with PCB plates and the 'HP' version of the 'Edge Case'">
    <br/>
    <br/>
</p>
...
Repeat these steps for the **RIGHT** half of DELPHI, being sure to rename the `CIRCUITPY` drive to `DELPHI_R` at step 3 *(must be exactly this!)*
